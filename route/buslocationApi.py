...
#     returnData["data"] = dict()
#     for eachBusData in response:
#         busRouteUID += (eachBusData["RouteUID"],)
#         returnData["data"][eachBusData["RouteUID"]] = {
#             "platenumb": eachBusData["PlateNumb"],
#             "direction": eachBusData["Direction"],
#             "longitude": eachBusData["BusPosition"]["PositionLon"],
#             "latitude": eachBusData["BusPosition"]["PositionLat"],
#             "speed": eachBusData["Speed"],
#         }
#     format_strings = ",".join(["%s"] * len(response))
#     selectSql = f"SELECT routeUID, routename_tw, routename_en, depname_tw, depname_en, destname_tw, destname_en FROM busroute WHERE routeUID IN ({format_strings})"
#     result = mysql.readData(selectSql, busRouteUID)
#     for routeData in result:
#         returnData["data"][routeData[0]]["routename"] = {
#             "tw": routeData[1],
#             "en": routeData[2],
...
#         if returnData["data"][routeData[0]]["direction"] == 1:
#             returnData["data"][routeData[0]]["depdestname"] = {
#                 "depname_tw": routeData[5],
#                 "depname_en": routeData[6],
#                 "destname_tw": routeData[3],
#                 "destname_en": routeData[4],
#             }
#         else:
#             returnData["data"][routeData[0]]["depdestname"] = {
#                 "depname_tw": routeData[3],
